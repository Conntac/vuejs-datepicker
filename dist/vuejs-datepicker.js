(function (global, factory) {
  ...
  var utils = {
     ...
     * @return {Number}
     */
    weekNumber: function weekNumber(timestamp) {
      var beginOfCurrentYear = new Date(new Date(timestamp).getUTCFullYear(), 0, 1);
      var millisecondsSinceBeginOfYear = timestamp - beginOfCurrentYear.getTime();
      var weekInMilliseconds = 604800000; // 7 * 24 * 60 * 60 * 60 * 1000
      ...
      [
        ...
        _c("header", [
          _c("span", {
            ...
            domProps: { innerHTML: _vm._s(_vm.prevButton) },
            on: {
              click: function($event) {
          ...
          _c("span", {
            ...
            domProps: { innerHTML: _vm._s(_vm.nextButton) },
            on: {
              click: function($event) {
  ...
  var script$4 = {
    ...
    methods: {
      ...
      selectWeek: function selectWeek(week) {
        if (!this.allDaysInWeekDisabled(week)) {
          var _week$slice = week.slice(-1),
              _week$slice2 = _slicedToArray(_week$slice, 1),
              day = _week$slice2[0];
      ...
      allDaysInWeekDisabled: function allDaysInWeekDisabled(week) {
        return week.every(function (day) {
          return day === undefined || day.isDisabled;
        });
      },
      dayClasses: function dayClasses(day) {
        return {
      ...
      isWeekSelected: function isWeekSelected(week) {
        return week.some(function (day) {
          return day && day.isSelected;
        });
      },
    ...
    return _c(
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.showWeekView,
            expression: "showWeekView"
          }
        ],
        class: [
          _vm.calendarClass,
          "vdp-datepicker__calendar",
          "vdp-datepicker__calendar__week"
        ],
        style: _vm.calendarStyle,
        on: {
          mousedown: function($event) {
      ...
      [
        ...
        _c(
          ...
          { class: _vm.isRtl ? "flex-rtl" : "" },
          [
            _c("span", { staticClass: "cell day-header calendar-week" }),
            _vm._v(" "),
            _vm._l(_vm.daysOfWeek, function(d) {
              return _c(
                "span",
              ...
              return _c(
                "div",
                {
                  ...
                  class: {
                    ...
                    selected: _vm.isWeekSelected(week)
                  },
                  on: {
                    click: function($event) {
                ...
                [
                  _c("span", { staticClass: "cell calendar-week" }, [
                    _vm._v(_vm._s(_vm.getWeekNumber(week[6].timestamp)))
                  ]),
                  _vm._v(" "),
                  _vm._l(week, function(day) {
                    return [
                      day === undefined
                        ? _c("span", { key: day, staticClass: "cell day blank" })
                        : _c("span", {
                            key: day.timestamp,
  ...
  __vue_render__$4._withStripped = true;
    ...
    var PickerWeek = normalizeComponent_1(
  ...
  var script$5 = {
    ...
    computed: {
       ...
       */
      expandedDisabledDates: function expandedDisabledDates() {
    ...
    methods: {
      ...
      allowedToShowView: function allowedToShowView(view) {
        var views = this.minimumView === 'week' ? ['week', 'month', 'year'] : ['day', 'month', 'year'];
      ...
      showWeekCalendar: function showWeekCalendar() {
          ...
          ? _c(
              "picker-day",
              {
                attrs: {
                  ...
                  disabledDates: _vm.expandedDisabledDates,
                  ...
                  "use-utc": _vm.useUtc,
                  "prev-button": _vm.prevButton,
                  "next-button": _vm.nextButton
                },
                on: {
